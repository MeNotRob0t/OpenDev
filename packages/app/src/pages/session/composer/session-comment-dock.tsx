...
// Variant of session-question-dock: puts a comment/note (e.g. visual test result, forgotten detail)
// instead of asking a clarifying question. Keeps the custom-input bottom option.
export const SessionCommentDock: Component<{ request: QuestionRequest; onSubmit: () => void }> = (props) => {
  const sdk = useSDK()
