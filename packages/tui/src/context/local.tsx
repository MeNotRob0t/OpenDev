  ...
  init: () => {
    ...
    function createAgent() {
      ...
      return {
        ...
        color(name: string) {
          if (name === "ask") return theme.success as RGBA
    ...
    function createModel() {
      ...
      const currentModel = createMemo(() => {
        ...
        // Preserve the selected model when switching agents by trying any
        // previously selected model before falling back to agent defaults.
        const preserved = Object.values(modelStore.model).find((m) => isModelValid(m))
        return (
          getFirstValidModel(
